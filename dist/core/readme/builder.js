...
function buildREADME(data) {
    return ((0, header_1.renderHeader)(data.projectName, data.description) +
        (0, features_1.renderFeatures)(data.projectType, data.aiFeatures) +
        (0, install_1.renderInstallation)(data.packageManager) +
        (0, usage_1.renderUsage)(data.projectType, data.entryPoints) +
        (0, techstack_1.renderTechStack)(data.languages, data.frameworks) +
